...
def main():
    ...
    try:
        ...
        logging.error("Unable to sync data between hosts, from: %s, to %s", options.from_path, options.to_path)
        sys.exit(4)
    sys.exit(0)
